...
class GLModel
{
  public:
    ...
    std::vector<Color>      colour;         // number of colours = number of triangles 
  ...
  public:
    ...
    *//*****************************************************************************/
    ...
    /****************************************************************************//*!
    @brief    Initialises a model. Data is laid out as SOA.
...
template <typename T>
void GLModel::SetVBO(const std::vector<T>& vtxData)
{
