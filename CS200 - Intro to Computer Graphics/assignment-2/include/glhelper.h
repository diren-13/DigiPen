...
struct GLHelper
{
    ...
    static GLdouble     dt;             // The current delta time between each frame
    ...
    static GLboolean    keystateW;      // The state of the 'W' key.
    static GLboolean    keystateR;      // The state of the 'R' key.
    static GLboolean    keystateL;      // The state of the 'L' key.
    static GLboolean    keystateX;      // The state of the 'L' key.
    static GLboolean    keystateZ;      // The state of the 'L' key.
    ...
    *//*********************************************************************************/
    ...
    static void APIENTRY debug_message_cb(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length,
