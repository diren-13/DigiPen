...
\date           June 14, 2022
\brief          Contains the interface for an AABB Tree.
...
namespace ClamChowder::Geometry
{
    ...
    public:
        ...
        /*-----------------------------------------------------------------------------*/
        AABBTree    (int size = DEFAULT_SIZE);
        AABBTree    (const std::vector<Drawable>& drawables, Method method, int size = DEFAULT_SIZE);
